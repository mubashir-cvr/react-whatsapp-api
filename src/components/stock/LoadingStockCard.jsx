...
function LoadingStockCard() {
  return (
    <div className="flex w-full min-h-12 opacity-20 animate-pulse  shadow-md max-h-32 flex-row text-xs justify-between text-black-900 items-center border-2 bg-white ">
