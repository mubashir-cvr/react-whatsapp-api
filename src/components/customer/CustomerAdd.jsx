...
function CustomerAdd({ handleModalClose, setCustomers,getCreatedCustomer }) {
  ...
  return (
    <div className="fixed w-full md:right-0 bottom-14 items-center overflow-scroll top-14 md:w-4/12 h-full bg-white p-4 border-2 shadow-md flex justify-center px-2">
      <div className="w-full p-2  border-2 md:border-0 px-3">
