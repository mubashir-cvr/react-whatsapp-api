...
function QuotationAdd({ handleModalClose, setQuotations }) {
  ...
  const getCreatedCustomer = (customer) => {
    setNewQuotation({ customer: customer });
    handleAddModalClose();
  };
    ...
    <div className="fixed inset-0 bg-slate-50 bg-opacity-50 flex items-center justify-center px-2">
      <div className="bg-white p-4 border-2 shadow-md w-full px-3 md:w-6/12">
        ...
        >
          <div className="flex flex-row gap-1 items-center justify-center w-full">
            <div className="flex mb-2 flex-1  relative w-full min-w-[200px]">
              <Select
                name="customer"
                options={customers}
            ...
            <div className="p-1 flex txt-sm text-gray-300">or</div>
            <div className="flex h-full p-2">
              <div
                onClick={() => setCustomerModal(true)}
                className="flex flex-col items-center h-full border hover:cursor-pointer border-pink-900 rounded-lg p-2"
              >
      ...
      {customerModal && (
        <CustomerAdd
          ...
          getCreatedCustomer={getCreatedCustomer}
        />
      )}
    </div>
  );
