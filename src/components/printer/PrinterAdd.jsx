...
function PrinterAdd({ handleModalClose, setPrinters }) {
  ...
  // Charges END
  return (
    <div className="fixed inset-0  overflow-scroll md:pt-36 pt-[200%] pb-32 bg-slate-50 bg-opacity-50 flex items-center justify-center px-2">
      <div className="bg-white p-4 border-2 shadow-md  px-3 ">
        <ModalHead heading={"Add Printer and Charge"} />
        <form
        ...
        >
          ...
          <p className="w-full pl-2 pb-2 text-xs text-gray-400 items-start">
            {" "}
            Charge breaks
          </p>
