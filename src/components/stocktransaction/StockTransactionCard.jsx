...
function StockTransactionCard({
  ...
  return (
    <div className="flex text-xs  w-full min-h-10  shadow-md max-h-32 flex-row md:text-sm justify-between text-black-900  items-center border bg-white ">
      ...
      <p className="flex w-1/6 md:w-1/6 border-r-2 h-full items-center justify-center">
        {StockTransaction.item.item_type}
      </p>
    
      {StockTransaction.inOrOut ==="IN" && <p className="flex text-green-500 font-medium w-1/6 md:w-1/6 border-r-2 h-full items-center justify-center"> {StockTransaction.quantity} </p>}
        {StockTransaction.inOrOut ==="OUT" && <p className="flex text-red-500 font-medium w-1/6 md:w-1/6 border-r-2 h-full items-center justify-center"> {StockTransaction.quantity}  </p>}
      ...
      <div className="w-1/6 flex-row flex md:w-1/6 items-center py-1 gap-1  md:gap-3 justify-center">
        <button
