      ...
      <div className="flex flex-col gap-2 md:w-4/12 w-10/12  border-2 rounded-lg justify-center bg-slate-100">
        ...
        <div className="flex flex-1 h-full px-4 md:px-16 md:py-8 p-6">
          <div className="border-2 flex flex-col gap-6 w-full h-full justify-center items-center rounded-2xl bg-white bg-opacity-60 p-4 md:p-8">
            ...
            <div className="flex-1"><button className="select-none rounded-lg border border-gray-400 py-2 px-3 text-center align-middle font-sans text-xs font-bold uppercase text-pink-900 transition-all hover:opacity-75 focus:ring focus:ring-gray-300 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">Login</button></div>
          </div>
        </div>
      </div>
    </div>
